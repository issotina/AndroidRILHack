...
import io.a41dev.ril2.telephony.uicc.AdnRecordCache;
import io.a41dev.ril2.telephony.uicc.AdnRecordLoader;
...
public abstract class IccRecords extends Handler implements IccConstants {
    ...
    protected void onIccRefreshInit() {
        adnCache.reset();
        if (mParentApp.getState() == IccCardApplicationStatus.AppState.APPSTATE_READY) {
