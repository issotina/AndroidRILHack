...
public class IccCardApplicationStatus {
    ...
    public IccCardStatus.PinState PinStateFromRILInt(int state) {
        IccCardStatus.PinState newPinState;
        switch(state) {
            case 0:
                newPinState = IccCardStatus.PinState.PINSTATE_UNKNOWN;
                break;
            case 1:
                newPinState = IccCardStatus.PinState.PINSTATE_ENABLED_NOT_VERIFIED;
                break;
            case 2:
                newPinState = IccCardStatus.PinState.PINSTATE_ENABLED_VERIFIED;
                break;
            case 3:
                newPinState = IccCardStatus.PinState.PINSTATE_DISABLED;
                break;
            case 4:
                newPinState = IccCardStatus.PinState.PINSTATE_ENABLED_BLOCKED;
                break;
            case 5:
                newPinState = IccCardStatus.PinState.PINSTATE_ENABLED_PERM_BLOCKED;
                break;
            default:
                newPinState = IccCardStatus.PinState.PINSTATE_UNKNOWN;
