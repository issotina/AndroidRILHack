...
import io.a41dev.ril2.SqliteWrapper;
...
import static io.a41dev.ril2.telephony.SmsManager.RESULT_ERROR_FDN_CHECK_FAILURE;
import static io.a41dev.ril2.telephony.SmsManager.RESULT_ERROR_LIMIT_EXCEEDED;
...
public abstract class SMSDispatcher extends Handler {
    ...
    protected SMSDispatcher(PhoneBase phone, SmsUsageMonitor usageMonitor,
     ...
     /*   mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor(
        ...
        mSmsCapable = /*mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_sms_capable*/true;
    ...
    protected void handleStatusReport(Object o) {
        Log.d(TAG, "handleStatusReport() called with no subclass.");
    }
    ...
    public void handleMessage(Message msg) {
        ...
        default:
            Log.e(TAG, "handleMessage() ignoring message of unexpected type " + msg.what);
        }
    }
    ...
    protected void handleSendComplete(AsyncResult ar) {
        ...
        if (ar.exception == null) {
            if (DBG) Log.d(TAG, "SMS send complete. Broadcasting intent: " + sentIntent);
            ...
            if (DBG) Log.d(TAG, "SMS send failed");
     ...
     */
    protected abstract GsmAlphabet.TextEncodingDetails calculateLength(CharSequence messageBody,
                                                                       boolean use7bitOnly);
...
*/
    ...
    public void sendRetrySms(SmsTracker tracker) {
        ...
        if (mImsSMSDispatcher != null) {
            ...
            Log.e(TAG, mImsSMSDispatcher + " is null. Retry failed");
        }
    }
    ...
    protected static final class SmsTracker {
        ...
        void writeSentMessage(Context context) {
            ...
            if (text != null) {
                ...
                mSentMessageUri = Telephony.Sms.addMessageToUri(context.getContentResolver(),
    ...
    public boolean isIms() {
        if (mImsSMSDispatcher != null) {
            ...
            Log.e(TAG, mImsSMSDispatcher + " is null");
            return false;
        }
    }
